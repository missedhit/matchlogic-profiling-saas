...
| **M1** | Cognito User Pool + `CognitoProvider` shim + JWT bearer + Mongo Atlas M10 + ECS Fargate + CloudFront + ACM + Route 53. Hello-world `/api/HealthCheck` reachable. Signup/login flow end-to-end. | ⬜ |
