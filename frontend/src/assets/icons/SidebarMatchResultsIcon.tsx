...
export function SidebarMatchResultsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      ...
      <path d="M11 11.5H6.99995V12.5H11V11.5Z" fill="currentColor" />
      <path d="M5.99995 11.5H4.99995V12.5H5.99995V11.5Z" fill="currentColor" />
      <path d="M11 9H6.99995V10H11V9Z" fill="currentColor" />
      <path d="M5.99995 9H4.99995V10H5.99995V9Z" fill="currentColor" />
      <path d="M11 6.5H6.99995V7.5H11V6.5Z" fill="currentColor" />
      <path d="M5.99995 6.5H4.99995V7.5H5.99995V6.5Z" fill="currentColor" />
      <path
