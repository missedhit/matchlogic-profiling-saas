...
/** Info/Help icon in a square frame (used in Data Import context) */
export function DataImportHelpIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="16"
      height="16"
