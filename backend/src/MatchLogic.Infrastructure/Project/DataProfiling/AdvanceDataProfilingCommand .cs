...
{
    public class AdvanceDataProfilingCommand : BaseCommand
    {
        private readonly IAdvancedDataProfiler _dataProfiler;
        private readonly IDataStore _dataStore;
        private readonly ILogger<AdvanceDataProfilingCommand> _logger;
        private readonly IGenericRepository<Domain.Project.DataSource, Guid> _dataSourceRepository;

        public AdvanceDataProfilingCommand(
            ...
            IAdvancedDataProfiler dataProfiler,
            IGenericRepository<Domain.Project.DataSource, Guid> dataSourceRepository,
            ILogger<AdvanceDataProfilingCommand> logger)
