...
public class CreateCleansingRuleCommandValidator
    : BaseCleansingRuleCommandValidator<CreateCleansingRuleCommand, CreateCleansingRuleResponse>
{
    public CreateCleansingRuleCommandValidator(
