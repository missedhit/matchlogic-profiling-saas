...
public class AddItemsToDictionaryCategoryValidator : AbstractValidator<AddItemsToDictionaryCategoryRequest>
{
    public AddItemsToDictionaryCategoryValidator(IGenericRepository<Domain.Dictionary.DictionaryCategory, Guid> dictionaryRepository)
    {
        RuleFor(x => x.Id)
